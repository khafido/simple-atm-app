...
public class ATMRepositoryTest {
    ...
    private static Account customer1 = mock(Account.class);
    private static Account customer2 = mock(Account.class);
    private static Account customer3 = mock(Account.class);
    ...
    void testFailWithdrawInsufficientBalance() {
        Transaction.Status result = atmRepository.withdrawMoney(999999, card1, "2022-02-02 22:00:00");
        assertEquals(Transaction.Status.FAILED, result);
    }

    @Test
    void testSuccessWithdraw() {
        Transaction.Status result = atmRepository.withdrawMoney(200, card1, "2022-02-02 22:00:00");
        assertEquals(Transaction.Status.SUCCESS, result);
    }

    @Test
    void testSuccessDeposit() {
        Transaction.Status result = atmRepository.depositMoney(100, card1);
        assertEquals(Transaction.Status.SUCCESS, result);
    }

    @Test
    void testFailTransferInvalidDestionation() {
        Transaction.Status result = atmRepository.transferMoney(100, card1, "999999", null, null);
        assertEquals(Transaction.Status.FAILED, result);
    }

    @Test
    void testFailTransferInsufficientBalance() {
        Transaction.Status result = atmRepository.transferMoney(1000000, card1, "777106", "645831",
                "2022-02-02 22:00:00");
        assertEquals(Transaction.Status.FAILED, result);
    }
    ...
    void testSuccessTransfer() {
        Transaction.Status result = atmRepository.transferMoney(100, card1, "777106", "645831", "2022-02-02 22:00:00");
        assertEquals(Transaction.Status.SUCCESS, result);
    }
}
